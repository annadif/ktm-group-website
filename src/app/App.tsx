...
export default function App() {
  ...
  return (
    <div className="font-sans bg-white text-gray-800 overflow-hidden text-center md:text-left">
      ...
      >
        <div className="w-full max-w-none px-0 md:mx-auto md:max-w-[860px]">
        ...
        <AnimatePresence>
          {false && isMenuOpen && (
            ...
            >
              <div className="w-full max-w-none px-0 py-4 md:mx-auto md:max-w-[860px]">
      ...
      >
        <div className="w-full max-w-none px-0 relative z-10 md:mx-auto md:max-w-[860px]">
