...
export default function App() {
  ...
  return (
    <div className="font-sans bg-white text-gray-800 overflow-hidden text-center md:text-left">
      ...
      >
        <div className="mx-auto max-w-[1280px] px-4 md:px-6 lg:px-[170px]">
        ...
        <AnimatePresence>
          {false && isMenuOpen && (
            ...
            >
              <div className="mx-auto max-w-[1280px] px-4 md:px-6 lg:px-[170px] py-4">
      ...
      >
        <div className="mx-auto max-w-[1280px] px-4 md:px-6 lg:px-[170px] relative z-10">
