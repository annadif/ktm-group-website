...
export default function App() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Services professionnels variés incluant consultation, expertise technique, études de faisabilité et accompagnement sur mesure.",
      icon: <Wrench size={32} />,
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">(+235) 92 92 48 34</p>
                </div>
              </div>
